                    ...
                    <div class="card">
					 ...
					 <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="prodno" class="form-control" id="prod" aria-describedby="emailHelp" placeholder="Enter Total number of products " required>
                                
                                </div>
                                
                                <div class="form-group">
                                    <label for="name">Total Price </label>
                                    <input type="text" name="price" class="form-control" id="prod" aria-describedby="emailHelp" placeholder="Enter Total price " required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input  type="date" name="date" class="form-control" id="date" aria-describedby="currentdate" required>
