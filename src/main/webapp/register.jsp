                    ...
                    <div class="card">                        
                        ...
                        <div class="card-body px-5"style="color:#FF00FF;">
                            ...
                            <form action="register" method="post"  >
                                ...
                                <div class="form-group">
                                    <label for="phone">Login Role</label>
                                    <input name="user_loginrole" type="text" class="form-control" id="phone" placeholder="Enter Login Role here" aria-describedby="emailHelp">
                                </div>
